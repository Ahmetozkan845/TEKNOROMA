function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>Detay Linki:</td><td><a title="Detay" href="/Administration/Territory/TerritoryList/' + aData[1] + '">' + aData[2] + ' detay </a></td></tr>';
    sOut += '<tr><td>Tedarikçi Ekleme:</td><td> <a href="/Administration/Territory/AddTerritory" class="btn btn-info"> Bölge Ekle<a/> </td></tr>';
    sOut += '</table>';
