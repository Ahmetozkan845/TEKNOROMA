function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>Detay Linki:</td><td><a title="Detay" href="/Administration/Supplier/SupplierList/' + aData[1] + '">' + aData[2] + ' detay </a></td></tr>';
    sOut += '<tr><td>Tedarikçi Ekleme:</td><td> <a href="/Administration/Supplier/AddSupplier" class="btn btn-info"> Tedarikçi Ekle<a/> </td></tr>';
    sOut += '</table>';
