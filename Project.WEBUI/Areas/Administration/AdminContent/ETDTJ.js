function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>Detay Linki:</td><td><a title="Detay" href="/Administration/EmployeeTerritory/EmployeeTerritoryList/' + aData[1] + '">' + aData[2] + ' detay </a></td></tr>';
    sOut += '<tr><td>Tedarikçi Ekleme:</td><td> <a href="/Administration/EmployeeTerritory/AddEmployeeTerritory" class="btn btn-info"> Çalışan Bölgesi Ekle<a/> </td></tr>';
    sOut += '</table>';
