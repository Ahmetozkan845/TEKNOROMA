function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>Detay Linki:</td><td><a title="Detay" href="/Administration/Expense/ExpenseList/' + aData[1] + '">' + aData[2] + ' detay </a></td></tr>';
    sOut += '<tr><td>Tedarikçi Ekleme:</td><td> <a href="/Administration/Expense/AddExpense" class="btn btn-info"> Gider Ekle<a/> </td></tr>';
    sOut += '</table>';
