function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>Detay Linki:</td><td><a title="Detay" href="/Administration/Employee/EmployeeList/' + aData[1] + '">' + aData[2] + ' detay </a></td></tr>';
    sOut += '<tr><td>Çalışan Ekleme:</td><td> <a href="/Administration/Employee/AddEmployee" class="btn btn-info"> Çalışan Ekle<a/> </td></tr>';
    sOut += '</table>';
